function Get-Services {
    ...
    Process {
        ...
        Get-WmiObject -Class Win32_Service | Select-Object @{ l="Server";e={$name} },Name,State,StartMode | Write-Output


        $VMNames | ForEach-Object {
            Invoke-Command -ComputerName $_ -ArgumentList $_ -ScriptBlock {
                Param([string]$VMName)
                Get-WmiObject -class Win32_Service | Select-Object @{ l="Server";e={$VMName} },Name, State, StartMode
            }
        } | Write-Output
